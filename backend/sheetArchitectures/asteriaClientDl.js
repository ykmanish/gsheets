const SHEET_ID = "1ZqSzx7AmdzHEbAeIdsqNk7WesUzujfOYeMqBqMS7Zzs";
const KIND = "asteria-client-dl";
...
function apply(architecture, sheetData = []) {
  ...
  return {
    ...architecture,
    kind: KIND,
    displayName: "Asteria Client Design & Cost Dashboard",
    summary: {
      ...architecture.summary,
      purpose: "Give leadership one view of the Asteria design estimate, room and category costs, financial commitments, and scope decisions.",
