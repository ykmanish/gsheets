const SHEET_ID = "1QXNfaLDIBDodB_6MJJQzc1WfDOEJJmD7QK7oElog48I";
const KIND = "devsharnam-client-dl";
...
function apply(architecture, sheetData = []) {
  ...
  return {
    ...architecture,
    kind: KIND,
    displayName: "Devsharnam Client Design & Cost Dashboard",
    summary: {
      ...architecture.summary,
      purpose: "Give leadership one view of the Devsharnam design estimate, room and category costs, financial commitments, and scope decisions.",
