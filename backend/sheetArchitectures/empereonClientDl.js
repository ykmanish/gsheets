const SHEET_ID = "1Vssic77Xwu1n5PkLNyt_JX3vcQJC7pGZ9JEy38mls_E";
const KIND = "empereon-client-dl";
...
function apply(architecture, sheetData = []) {
  ...
  return {
    ...architecture,
    kind: KIND,
    displayName: "The Empereon Client Design & Cost Dashboard",
    summary: {
      ...architecture.summary,
      purpose: "Give leadership one view of The Empereon design estimate, room and category costs, financial commitments, and scope decisions.",
