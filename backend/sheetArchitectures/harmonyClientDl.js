const SHEET_ID = "1ODlhHT0kf9HEkHNiNYpirmOYssAhzGCBWUes_HNt6Gc";
const KIND = "harmony-client-dl";
...
function apply(architecture, sheetData = []) {
  ...
  return {
    ...architecture,
    kind: KIND,
    displayName: "Harmony Client Design & Cost Dashboard",
    summary: {
      ...architecture.summary,
      purpose: "Give leadership one view of the Harmony design estimate, room and category costs, financial commitments, and scope decisions.",
